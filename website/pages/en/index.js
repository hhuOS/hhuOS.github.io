...
const Features = props => (
    <Container>
        ...
        <Feature title="Shell" content="The operating offers a simple unix-like Shell, allowing the user to interact with the filesystem." image={imgUrl('screenshots/shell.png')}/>
